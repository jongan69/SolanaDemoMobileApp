...
export class PhantomWalletService {
  ...
  public async signAndSendTransaction() {
    ...
    const transaction = await createTransferTransaction(this.phantomWalletPublicKey, this.phantomWalletPublicKey, 100);
  ...
  public async signAllTransactions() {
    ...
    const transactions = await Promise.all([
      createTransferTransaction(this.phantomWalletPublicKey, this.phantomWalletPublicKey, 100),
      createTransferTransaction(this.phantomWalletPublicKey, this.phantomWalletPublicKey, 100)
    ]);
